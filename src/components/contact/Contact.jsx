...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_l3d566k', 'template_bek4wkl', form.current, 'h73p9DO2_hzGgh6Dz')
            .then((result) => {
                setEmail("")
                setName("")
                setMessage("")
                setError(false)
                alert("Your Email has been sent to us successfully!")
            }, (error) => {
                setError(true)
                alert("Sorry something wrong occurred")
            });
    };
        ...
        <motion.div className='contact' variants={variants} initial="initial" whileInView={"animate"}>
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="mail" variants={variants}>
                    <h3>E-mail</h3>
                    <p>aayushpatel512003@gmail.com</p>
                </motion.div>
                <motion.div className="address" variants={variants}>
                    <h3>Address</h3>
                    <p>Manipal University Jaipur, Rajasthan</p>
                </motion.div>
